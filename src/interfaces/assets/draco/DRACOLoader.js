...
DRACOLoader.getDecoderModule = function () {
    ...
    // Load with asm.js.
        promise = DRACOLoader._loadScript(path + 'draco_decoder_gltf.js');
    } else {
    // Load with WebAssembly.
        config.wasmBinaryFile = path + 'draco_decoder_gltf.wasm';
        promise = DRACOLoader._loadScript(path + 'draco_wasm_wrapper_gltf.js')
            .then(function () {
